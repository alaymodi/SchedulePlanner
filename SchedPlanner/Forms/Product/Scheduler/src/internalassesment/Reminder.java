...
public class Reminder extends javax.swing.JFrame{
    ...
    public Reminder() {
        ...
        try {            
            ...
            myClip.open(AudioSystem.getAudioInputStream(new File("AlarmClock.wav")));           //opens the file that audio clip should play
            myClip.start();
        } catch (Exception ex) {
            myClip = null;
        } 
        ...
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);                          
                addWindowListener(new WindowAdapter() {             //adds window listener to detect when program closes
            @Override
            public void windowClosing(WindowEvent e) {         //overrides the default method for when window is closin
                try {
